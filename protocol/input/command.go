...
type DispatchKeyEventArgs struct {
	...
	Timestamp             *shared.TimeSinceEpoch `json:"timestamp,omitempty"`             // Time at which the event occurred.
...
type EmulateTouchFromMouseEventArgs struct {
	...
	Timestamp  *shared.TimeSinceEpoch `json:"timestamp,omitempty"`  // Time at which the event occurred (default: current time).
